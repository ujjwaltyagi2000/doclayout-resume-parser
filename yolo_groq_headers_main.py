...
This script is the main script for processing resumes using YOLO layout parser and Groq (llama-3.1-8b)
...
if __name__ == "__main__":
    ...
    pdf_path = "documents/ESG Profile - Toshi Satwaskar.pdf"
    ...
    yolo_section_headers = []
    
    for result in results["blocks"]:  # print first 5 blocks for brevity
        if result["class_id"] == 7:
            # print(result)
            yolo_section_headers.append(result["text"])

    print("YOLO Detected Section Header Objects:", len(yolo_section_headers))
    ...
    # cleaned_headers = filter_headers_with_groq(linewise_content_with_fonts, cleaned_headers_prompt_template_v3)
    ...
    print("✅ YOLO Headers with Fonts:", yolo_headers_with_fonts)
