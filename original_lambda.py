...
def process_resume(pdf_bytes, experience, file_name):
    ...
    filler_words, total_filler_words, all_filler_words = get_filler_words(resume_text)
    ...
    measurable = get_namedEntityMeasurable(resume_text) # experience and projects content only
    ...
    clean_measurable = get_measurableUpdated(resume_text,finalBullet,measurable,all_phones,dates) # experience and projects content only
...
if __name__ == "__main__":
    ...
    pd.DataFrame(analysis_results).to_csv("original_code_metrics_2704.csv", index=False)
